...
if(isset($_POST["add_to_cart"]))
{
	...
	header("location:SeedMixes.php?success=1");
}
...
if(isset($_GET["action"]))
{
	if($_GET["action"] == "delete")
	{
		...
		foreach($cart_data as $keys => $values)
		{
			if($cart_data[$keys]['item_id'] == $_GET["id"])
			{
				...
				$item_data = json_encode($cart_data);
				setcookie("shopping_cart", $item_data, time() + (86400 * 30));
				header("location:SeedMixes.php?remove=1");
			}
		}
	}
	if($_GET["action"] == "clear")
	{
		...
		header("location:SeedMixes.php?clearall=1");
	}
}
...
<div class="list-group" id="show-list">
		...
		<div class="container">
			<br />
			<h3 align="center">Bird Food Seed Mixes</h3><br />
			<br /><br />
			<?php
			...
			<div class="col-md-3">
				<form method="post">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;height:500px;" align="center">
						<img src="img/seedmixes/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
