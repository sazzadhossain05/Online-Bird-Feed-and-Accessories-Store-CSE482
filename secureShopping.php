...
<hr>
<section class="secureshopping">

<h1>Secure Shopping</h1>

<p>GardenBird take the security of our customer's personal data very seriously. 
Industry best practices have been employed in the design and development of the GardenBird website.
 Independent Internet security specialists were used to validate the site security.</p>

<p>Steps taken to ensure security include: Once your order is completed all your data is securely transmitted to a GardenBird server that is
 not accessible by anyone via the Internet. Access to the GardenBird Servers containing sensitive information is prevented using firewall technology.</p>

<p>All customers are authenticated before payment details are captured. Internet users can browse the contents of the site, but cannot order from 
the site until they have registered. No ability to access customer account maintenance or to view customer order history will be allowed without
 the provision of a secure password by a customer.</p>

<p>All transmissions of sensitive information from a client's session to the GardenBird servers and vice–versa are secured using 
industry standard SSL encryption techniques.</p>
