...
<input type="hidden" name="hosted_button_id" value="TCWHBQFB829W2">
...
<!-- Paypal payment end-->
			...
			<!-- payment -->
		<section class="container">
		<h2>Please use the following steps to pay by BKASH</h2>
		<ul>
		<li>Go to bKash Menu by dialing *247#</li>
		<li>Choose 'Payment' option by pressing '3'</li>
		<li>Enter our Merchant wallet number : 01763649097</li>
		...
		<section>
		<img src="img/bkpay1.jpg" style="margin:5px;width:800px;height:500px;border:0">
		</section>
		<!-- payment end-->
		<hr>
<!--Footer part-->
