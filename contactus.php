      ...
      <div class="container">
        <article id="main-col">
          ...
          <ul id="services">
            <li>
              ...
              <p>Please feel free to contact us with any questions or queries you may have.
			  We can be contacted by email, by telephone, or in writing at the details below.</p>
						  
            </li>
            <li>
              <h3>By email</h3>
              <p>help@birdsfood.co.bd</p>
			  <h3>By mail</h3>
			  <p>Bhasundhora Gate, Kuril - NSU Rd, Dhaka 1229</p> 
            </li>
            <li>
              <h3>By telephone</h3>
              <p>01913483542</p>
        ...
        <aside id="sidebar">
          <div class="dark">
            ...
            <form method="POST" action="feedbackquery.php" class="quote">
  						<div>
  							<label>Name</label><br>
  						...
  						<div>
  							...
  							<input type="email" name="eml"placeholder="Emial Address">
  						</div>
  						<div>
